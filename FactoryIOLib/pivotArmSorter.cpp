...
FactoryIO::pivotArmSorter_t::pivotArmSorter_t(modbus& mb, modbusAddr_t plusAddr, modbusAddr_t minusAddr, modbusAddr_t turnAddr) :
...
void FactoryIO::pivotArmSorter_t::setArmPosition(bool extended) {
	...
	mb.modbus_write_coil(_turnAddr, extended);
}
